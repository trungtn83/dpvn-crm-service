...
public class SaleCustomerService {
  ...
  public void removeSaleCustomerByReason(Long saleId, Long customerId, Integer reasonId, String reasonRef) {
  ...
  public SaleCustomerDto findSaleCustomerByReason(Long saleId, Long customerId, Integer type, Integer reasonId, String reasonRef) {
    FastMap options = FastMap.create()
        .add("saleId", saleId)
